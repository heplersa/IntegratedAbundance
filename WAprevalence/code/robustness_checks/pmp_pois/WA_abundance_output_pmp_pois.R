...
load("WAprevalence/output/mcmc/MCMC_no_covariates_pmp_pois_2026_02_16.Rda")

# IMPORT SHAPE FILES FOR WA COUNTIES
load("WAprevalence/data/shape_county_WA.Rda")

# EXAMINE MCMC CONVERGENCE
MCMCvis::MCMCtrace(samples, params = paste0("pi[", sample(1:234, 20), ", 1]"), ISB = F, filename = "pmp", wd = "WAprevalence/output/robustness_checks/pmp_pois/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("pi[", sample(1:234, 20), ", 2]"), ISB = F, filename = "death", wd = "WAprevalence/output/robustness_checks/pmp_pois/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("pi[", sample(79:234, 20), ", 3]"), ISB = F, filename = "ed", wd = "WAprevalence/output/robustness_checks/pmp_pois/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("pi[", sample(1:234, 20), ", 4]"), ISB = F, filename = "hosp", wd = "WAprevalence/output/robustness_checks/pmp_pois/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("N[", sample(1:234, 20), "]"), ISB = F, filename = "N", wd = "WAprevalence/output/robustness_checks/pmp_pois/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("lambda[", sample(1:234, 20), "]"), ISB = F, filename = "lambda", wd = "WAprevalence/output/robustness_checks/pmp_pois/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("f[", sample(1:234, 20), ", 1]"), ISB = F, filename = "f_pmp", wd = "WAprevalence/output/robustness_checks/pmp_pois/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("f[", sample(1:234, 20), ", 2]"), ISB = F, filename = "f_death", wd = "WAprevalence/output/robustness_checks/pmp_pois/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("f[", sample(79:234, 20), ", 3]"), ISB = F, filename = "f_ed", wd = "WAprevalence/output/robustness_checks/pmp_pois/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("f[", sample(1:234, 20), ", 4]"), ISB = F, filename = "f_hosp", wd = "WAprevalence/output/robustness_checks/pmp_pois/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("v[", sample(1:234, 20), "]"), ISB = F, filename = "v", wd = "WAprevalence/output/robustness_checks/pmp_pois/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("u[", sample(1:234, 20), "]"), ISB = F, filename = "u", wd = "WAprevalence/output/robustness_checks/pmp_pois/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("beta[", 1:7, ", 1]"), ISB = F, filename = "beta_pmp", wd = "WAprevalence/output/robustness_checks/pmp_pois/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("beta[", 1:7, ", 2]"), ISB = F, filename = "beta_death", wd = "WAprevalence/output/robustness_checks/pmp_pois/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("beta[", 3:7, ", 3]"), ISB = F, filename = "beta_ed", wd = "WAprevalence/output/robustness_checks/pmp_pois/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("beta[", 1:7, ", 4]"), ISB = F, filename = "beta_hosp", wd = "WAprevalence/output/robustness_checks/pmp_pois/diagnostics")
MCMCvis::MCMCtrace(samples, params = "beta.mu", filename = "beta.mu", wd = "WAprevalence/output/robustness_checks/pmp_pois/diagnostics")
MCMCvis::MCMCtrace(samples, params = "mu", filename = "mu", wd = "WAprevalence/output/robustness_checks/pmp_pois/diagnostics")
MCMCvis::MCMCtrace(samples, params = "tau.f", filename = "tau.f", wd = "WAprevalence/output/robustness_checks/pmp_pois/diagnostics")
MCMCvis::MCMCtrace(samples, params = "tau.u", filename = "tau.u", wd = "WAprevalence/output/robustness_checks/pmp_pois/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("eps[", sample(1:234, 20), ", 1]"), ISB = F, filename = "eps_pmp", wd = "WAprevalence/output/robustness_checks/pmp_pois/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("eps[", sample(1:234, 20), ", 2]"), ISB = F, filename = "eps_death", wd = "WAprevalence/output/robustness_checks/pmp_pois/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("eps[", sample(1:234, 20), ", 3]"), ISB = F, filename = "eps_ed", wd = "WAprevalence/output/robustness_checks/pmp_pois/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("eps[", sample(1:234, 20), ", 4]"), ISB = F, filename = "eps_hosp", wd = "WAprevalence/output/robustness_checks/pmp_pois/diagnostics")
MCMCvis::MCMCtrace(samples, params = "cov.eps", filename = "cov.eps", wd = "WAprevalence/output/robustness_checks/pmp_pois/diagnostics")
...
write.csv(pmp_results_csv,
          file = "WAprevalence/output/robustness_checks/pmp_pois/tables/pmp_results.csv",
          row.names = F)

write.csv(death_results_csv,
          file = "WAprevalence/output/robustness_checks/pmp_pois/tables/death_results.csv",
          row.names = F)

write.csv(ed_results_csv,
          file = "WAprevalence/output/robustness_checks/pmp_pois/tables/ed_results.csv",
          row.names = F)

write.csv(hosp_results_csv,
          file = "WAprevalence/output/robustness_checks/pmp_pois/tables/hosp_results.csv",
          row.names = F)

write.csv(N_results_csv,
          file = "WAprevalence/output/robustness_checks/pmp_pois/tables/N_results.csv",
          row.names = F)

write.csv(N_prev_results_csv,
          file = "WAprevalence/output/robustness_checks/pmp_pois/tables/N_prev_results.csv",
          row.names = F)
...
ggsave(filename = "pmp.png", 
       plot = pmp_map, 
       path = "WAprevalence/output/robustness_checks/pmp_pois/maps", 
       bg = "White",
       dpi = "retina",
       height = 3,
       width = 10)
...
# binomial outcomes
post_binom_outcome_prev <- apply(samples[, beta_lwr:(beta_lwr+6)], 2, ilogit)

# poisson outcomes; exclude 2017-2018 for ED visit outcome
post_pois_outcome_prev <- apply(samples[, c((beta_lwr+7):(beta_lwr+7+6), (beta_lwr+7+6+3):beta_upr)], 2, exp)
...
post_outcome_prev <- list(c(post_binom_outcome_prev[[1]], post_pois_outcome_prev[[1]][1:7], NA, NA, post_pois_outcome_prev[[1]][8:19]),
                          cbind(post_binom_outcome_prev[[2]], post_pois_outcome_prev[[2]][,1:7], matrix(c(NA, NA, NA, NA), nrow=2, ncol=2), post_pois_outcome_prev[[2]][,8:19]))
...
ggsave(filename = "beta_log.png",
       path = "WAprevalence/output/robustness_checks/pmp_pois",
       dpi = "retina",
       width = 13,
       height = 10,
       units = "cm"
