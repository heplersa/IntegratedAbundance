...
load("WAprevalence/output/mcmc/MCMC_no_covariates_12yr_or_older_pop_12_2026_03_05.Rda")

# IMPORT SHAPE FILES FOR WA COUNTIES
load("WAprevalence/data/shape_county_WA.Rda")

# EXAMINE MCMC CONVERGENCE
MCMCvis::MCMCtrace(samples, params = paste0("pi[", sample(1:234, 20), ", 1]"), ISB = F, filename = "pmp", wd = "WAprevalence/output/robustness_checks/12yr_or_older_pop/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("pi[", sample(1:234, 20), ", 2]"), ISB = F, filename = "death", wd = "WAprevalence/output/robustness_checks/12yr_or_older_pop/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("pi[", sample(79:234, 20), ", 3]"), ISB = F, filename = "ed", wd = "WAprevalence/output/robustness_checks/12yr_or_older_pop/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("pi[", sample(1:234, 20), ", 4]"), ISB = F, filename = "hosp", wd = "WAprevalence/output/robustness_checks/12yr_or_older_pop/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("N[", sample(1:234, 20), "]"), ISB = F, filename = "N", wd = "WAprevalence/output/robustness_checks/12yr_or_older_pop/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("lambda[", sample(1:234, 20), "]"), ISB = F, filename = "lambda", wd = "WAprevalence/output/robustness_checks/12yr_or_older_pop/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("f[", sample(1:234, 20), ", 1]"), ISB = F, filename = "f_pmp", wd = "WAprevalence/output/robustness_checks/12yr_or_older_pop/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("f[", sample(1:234, 20), ", 2]"), ISB = F, filename = "f_death", wd = "WAprevalence/output/robustness_checks/12yr_or_older_pop/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("f[", sample(79:234, 20), ", 3]"), ISB = F, filename = "f_ed", wd = "WAprevalence/output/robustness_checks/12yr_or_older_pop/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("f[", sample(1:234, 20), ", 4]"), ISB = F, filename = "f_hosp", wd = "WAprevalence/output/robustness_checks/12yr_or_older_pop/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("v[", sample(1:234, 20), "]"), ISB = F, filename = "v", wd = "WAprevalence/output/robustness_checks/12yr_or_older_pop/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("u[", sample(1:234, 20), "]"), ISB = F, filename = "u", wd = "WAprevalence/output/robustness_checks/12yr_or_older_pop/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("beta[", 1:7, ", 1]"), ISB = F, filename = "beta_pmp", wd = "WAprevalence/output/robustness_checks/12yr_or_older_pop/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("beta[", 1:7, ", 2]"), ISB = F, filename = "beta_death", wd = "WAprevalence/output/robustness_checks/12yr_or_older_pop/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("beta[", 3:7, ", 3]"), ISB = F, filename = "beta_ed", wd = "WAprevalence/output/robustness_checks/12yr_or_older_pop/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("beta[", 1:7, ", 4]"), ISB = F, filename = "beta_hosp", wd = "WAprevalence/output/robustness_checks/12yr_or_older_pop/diagnostics")
MCMCvis::MCMCtrace(samples, params = "beta.mu", filename = "beta.mu", wd = "WAprevalence/output/robustness_checks/12yr_or_older_pop/diagnostics")
MCMCvis::MCMCtrace(samples, params = "mu", filename = "mu", wd = "WAprevalence/output/robustness_checks/12yr_or_older_pop/diagnostics")
MCMCvis::MCMCtrace(samples, params = "tau.f", filename = "tau.f", wd = "WAprevalence/output/robustness_checks/12yr_or_older_pop/diagnostics")
MCMCvis::MCMCtrace(samples, params = "tau.u", filename = "tau.u", wd = "WAprevalence/output/robustness_checks/12yr_or_older_pop/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("eps[", sample(1:234, 20), ", 1]"), ISB = F, filename = "eps_pmp", wd = "WAprevalence/output/robustness_checks/12yr_or_older_pop/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("eps[", sample(1:234, 20), ", 2]"), ISB = F, filename = "eps_death", wd = "WAprevalence/output/robustness_checks/12yr_or_older_pop/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("eps[", sample(1:234, 20), ", 3]"), ISB = F, filename = "eps_ed", wd = "WAprevalence/output/robustness_checks/12yr_or_older_pop/diagnostics")
MCMCvis::MCMCtrace(samples, params = paste0("eps[", sample(1:234, 20), ", 4]"), ISB = F, filename = "eps_hosp", wd = "WAprevalence/output/robustness_checks/12yr_or_older_pop/diagnostics")
MCMCvis::MCMCtrace(samples, params = "cov.eps", filename = "cov.eps", wd = "WAprevalence/output/robustness_checks/12yr_or_older_pop/diagnostics")
...
write.csv(pmp_results_csv,
          file = "WAprevalence/output/robustness_checks/12yr_or_older_pop/tables/pmp_results.csv",
          row.names = F)

write.csv(death_results_csv,
          file = "WAprevalence/output/robustness_checks/12yr_or_older_pop/tables/death_results.csv",
          row.names = F)

write.csv(ed_results_csv,
          file = "WAprevalence/output/robustness_checks/12yr_or_older_pop/tables/ed_results.csv",
          row.names = F)

write.csv(hosp_results_csv,
          file = "WAprevalence/output/robustness_checks/12yr_or_older_pop/tables/hosp_results.csv",
          row.names = F)

write.csv(N_results_csv,
          file = "WAprevalence/output/robustness_checks/12yr_or_older_pop/tables/N_results.csv",
          row.names = F)

write.csv(N_prev_results_csv,
          file = "WAprevalence/output/robustness_checks/12yr_or_older_pop/tables/N_prev_results.csv",
          row.names = F)
...
ggsave(filename = "pmp_obs_rate.png", 
       ...
       path = "WAprevalence/output/robustness_checks/12yr_or_older_pop/maps", 
       bg = "White",
       dpi = "retina",
       height = 3,
       width = 10)
...
ggsave(filename = "beta_log.png",
       path = "WAprevalence/output/robustness_checks/12yr_or_older_pop",
       dpi = "retina",
       width = 13,
       height = 10,
       units = "cm"
